 ...
 */
public class SpatialNumInteriorRingMethod4 extends AbstractSQLMethod
{
    public SQLExpression getExpression(SQLExpression expr, List args)
    {
        if (expr == null && (args == null || args.size() != 1))
        {
            throw new NucleusUserException("Cannot invoke Spatial.numInteriorRing without 1 argument");
        }
        else if (expr != null && args != null && args.size() != 0)
        {
            throw new NucleusUserException("Cannot invoke geom.getNumInteriorRing() with an argument");
        }
        ...
        return new NumericExpression(stmt, m, "st_numinteriorring", funcArgs);
    }
}
