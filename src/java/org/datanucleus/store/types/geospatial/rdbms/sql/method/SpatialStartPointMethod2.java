 ...
 */
public class SpatialStartPointMethod2 extends AbstractSQLMethod
{
    /*
     * (non-Javadoc)
     * @see
    ...
    public SQLExpression getExpression(SQLExpression expr, List args)
    {
        ...
        GeometryExpression startExpr = new GeometryExpression(stmt, null, "startPoint", startFuncArgs, null);
