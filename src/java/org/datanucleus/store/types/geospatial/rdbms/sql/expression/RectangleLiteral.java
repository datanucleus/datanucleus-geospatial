...
/**
 * Literal representing a java.awt.Rectangle. Does nothing much other than store the value.
 */
public class RectangleLiteral extends RectangleExpression implements SQLLiteral
{
    Rectangle value;

    public RectangleLiteral(SQLStatement stmt, JavaTypeMapping mapping, Object value, String parameterName)
    {
