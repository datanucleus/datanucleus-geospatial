 ...
 */
public class SpatialEnvelopeMethod2 extends AbstractSQLMethod
{
    /*
     * (non-Javadoc)
     * @see
    ...
    public SQLExpression getExpression(SQLExpression expr, List args)
    {
        ...
        {
            throw new NucleusUserException("Cannot invoke Spatial.envelope without 1 argument");
        }
        else if (expr != null && args != null && args.size() != 0)
        {
            throw new NucleusUserException("Cannot invoke geom.envelope() with an argument");
        }
        ...
        GeometryExpression geomEnvExpr = new GeometryExpression(stmt, null, "envelope", geomEnvFuncArgs, null);
