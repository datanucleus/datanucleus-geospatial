 ...
 */
public class SpatialGeomFromTextMethod extends AbstractSQLMethod
{
    /*
     * (non-Javadoc)
     * @see
    ...
    public SQLExpression getExpression(SQLExpression expr, List args)
    {
        ...
        {
            throw new NucleusUserException("Cannot invoke Spatial.geomFromText without 2 arguments");
        }
        ...
        return new GeometryExpression(stmt, null, "GeomFromText", funcArgs, null);
    }
}