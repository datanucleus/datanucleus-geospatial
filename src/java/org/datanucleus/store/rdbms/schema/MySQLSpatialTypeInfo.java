...
{
    public static final MySQLSpatialTypeInfo TYPEINFO_PROTOTYPE = new MySQLSpatialTypeInfo("",
        (short) Types.BINARY, 0, "", "", "", (short) DatabaseMetaData.typeNullable, false,
    ...
    public MySQLSpatialTypeInfo(String typeName, short dataType, int precision, String literalPrefix,
