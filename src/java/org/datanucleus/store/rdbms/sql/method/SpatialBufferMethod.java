 ...
 */
public class SpatialBufferMethod extends AbstractSQLMethod
{
    /* (non-Javadoc)
    ...
    public SQLExpression getExpression(SQLExpression expr, List args)
    {
        if (args == null)
        {
            throw new NucleusUserException("Cannot invoke Spatial.buffer without arguments");
        }
        ...
        return new GeometryExpression(stmt, geomMapping, "Buffer", funcArgs, null);
    }
}