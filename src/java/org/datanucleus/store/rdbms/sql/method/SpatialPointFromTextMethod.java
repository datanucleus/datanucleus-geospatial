 ...
 */
public class SpatialPointFromTextMethod extends AbstractSQLMethod
{
    /* (non-Javadoc)
    ...
    public SQLExpression getExpression(SQLExpression expr, List args)
    {
        ...
        {
            throw new NucleusUserException("Cannot invoke Spatial.pointFromText without 2 arguments");
        }
        ...
        return new GeometryExpression(stmt, null, "PointFromText", funcArgs, null);
    }
}