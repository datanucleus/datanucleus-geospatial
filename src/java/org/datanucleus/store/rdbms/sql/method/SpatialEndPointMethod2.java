 ...
 */
public class SpatialEndPointMethod2 extends AbstractSQLMethod
{
    /* (non-Javadoc)
    ...
    public SQLExpression getExpression(SQLExpression expr, List args)
    {
        ...
        {
            throw new NucleusUserException("Cannot invoke Spatial.endPoint without 1 argument");
        }
        else if (expr != null && args != null && args.size() != 0)
        {
            throw new NucleusUserException("Cannot invoke geom.getEndPoint() with an argument");
        }
        ...
        GeometryExpression startExpr = new GeometryExpression(stmt, null, "endPoint", startFuncArgs, null);
