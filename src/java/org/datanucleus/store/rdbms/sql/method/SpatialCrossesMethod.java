 ...
 */
public class SpatialCrossesMethod extends AbstractSQLMethod
{
    /*
     * (non-Javadoc)
     * @see
    ...
    public SQLExpression getExpression(SQLExpression expr, List args)
    {
        if (args == null)
        {
            throw new NucleusUserException("Cannot invoke Spatial.crosses without arguments");
        }
        ...
        return SpatialMethodHelper.getBooleanExpression(stmt, "Crosses", funcArgs, exprFactory);
    }
}