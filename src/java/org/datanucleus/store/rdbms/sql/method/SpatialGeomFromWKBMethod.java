 ...
 */
public class SpatialGeomFromWKBMethod extends AbstractSQLMethod
{
    /*
     * (non-Javadoc)
     * @see
    ...
    public SQLExpression getExpression(SQLExpression expr, List args)
    {
        ...
        {
            throw new NucleusUserException("Cannot invoke Spatial.geomFromWKB without 2 arguments");
        }
        ...
        return new GeometryExpression(stmt, null, "GeomFromWKB", funcArgs, null);
    }
}