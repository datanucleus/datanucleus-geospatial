 ...
 */
public class SpatialGeomCollFromWKBMethod extends AbstractSQLMethod
{
    /*
     * (non-Javadoc)
     * @see
    ...
    public SQLExpression getExpression(SQLExpression expr, List args)
    {
        ...
        {
            throw new NucleusUserException("Cannot invoke Spatial.geomCollFromWKB without 2 arguments");
        }
        ...
        return new GeometryExpression(stmt, null, "GeomCollFromWKB", funcArgs, null);
    }
}