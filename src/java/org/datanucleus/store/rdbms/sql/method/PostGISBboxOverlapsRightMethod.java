 ...
 */
public class PostGISBboxOverlapsRightMethod extends AbstractSQLMethod
{
    ...
    public SQLExpression getExpression(SQLExpression ignore, List args)
    {
        ...
        {
            throw new NucleusUserException("Cannot invoke PostGIS.bboxOverlapsRight without 2 arguments");
        }
