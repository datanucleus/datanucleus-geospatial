 ...
 */
public class SpatialPolyFromTextMethod extends AbstractSQLMethod
{
    /* (non-Javadoc)
    ...
    public SQLExpression getExpression(SQLExpression expr, List args)
    {
        ...
        {
            throw new NucleusUserException("Cannot invoke Spatial.polyFromText without 2 arguments");
        }
        ...
        return new GeometryExpression(stmt, null, "PolyFromText", funcArgs, null);
    }
}