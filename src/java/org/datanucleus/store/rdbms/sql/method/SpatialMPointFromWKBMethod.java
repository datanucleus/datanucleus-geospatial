 ...
 */
public class SpatialMPointFromWKBMethod extends AbstractSQLMethod
{
    /* (non-Javadoc)
    ...
    public SQLExpression getExpression(SQLExpression expr, List args)
    {
        ...
        {
            throw new NucleusUserException("Cannot invoke Spatial.mPointFromWKB without 2 arguments");
        }
        ...
        return new GeometryExpression(stmt, null, "MPointFromWKB", funcArgs, null);
    }
}