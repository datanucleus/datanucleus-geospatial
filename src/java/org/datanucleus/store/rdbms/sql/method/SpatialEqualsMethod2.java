 ...
 */
public class SpatialEqualsMethod2 extends AbstractSQLMethod
{
    /*
     * (non-Javadoc)
     * @see
    ...
    public SQLExpression getExpression(SQLExpression expr, List args)
    {
        if (args == null)
        {
            throw new NucleusUserException("Cannot invoke Spatial.equals without arguments");
        }
        if (expr == null && args.size() != 2)
        {
            throw new NucleusUserException("Cannot invoke Spatial.equals without 2 arguments");
        }
        else if (expr != null && args.size() != 1)
        {
            throw new NucleusUserException("Cannot invoke geom.equals() without 1 argument");
        }
        ...
        return SpatialMethodHelper.getBooleanExpression(stmt, "equals", funcArgs, exprFactory);
    }
}