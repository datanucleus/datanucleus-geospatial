 ...
 */
public class SpatialUnionMethod extends AbstractSQLMethod
{
    /*
     * (non-Javadoc)
     * @see
    ...
    public SQLExpression getExpression(SQLExpression expr, List args)
    {
        if (args == null)
        {
            throw new NucleusUserException("Cannot invoke Spatial.union without arguments");
        }
        ...
        return new GeometryExpression(stmt, geomMapping, "Union", funcArgs, null);
    }
}