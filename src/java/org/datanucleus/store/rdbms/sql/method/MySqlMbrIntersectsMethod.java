 ...
 */
public class MySqlMbrIntersectsMethod extends AbstractSQLMethod
{
	/* (non-Javadoc)
    ...
    public SQLExpression getExpression(SQLExpression ignore, List args)
    {
        ...
        {
            throw new NucleusUserException("Cannot invoke MySQL.mbrIntersects without 2 arguments");
        }
        ...
        return SpatialMethodHelper.getBooleanExpression(stmt, "MBRIntersects", funcArgs, exprFactory);
    }
}