 ...
 */
public class SpatialPolyFromWKBMethod extends AbstractSQLMethod
{
    /*
     * (non-Javadoc)
     * @see
    ...
    public SQLExpression getExpression(SQLExpression expr, List args)
    {
        ...
        {
            throw new NucleusUserException("Cannot invoke Spatial.polyFromWKB without 2 arguments");
        }
        ...
        return new GeometryExpression(stmt, null, "PolyFromWKB", funcArgs, null);
    }
}