 ...
 */
public class SpatialIntersectsMethod3 extends AbstractSQLMethod
{
    public SQLExpression getExpression(SQLExpression expr, List args)
    {
        if (args == null)
        {
            throw new NucleusUserException("Cannot invoke Spatial.intersects without arguments");
        }
        ...
        {
            throw new NucleusUserException("Cannot invoke geom.intersects() without 1 argument");
        }
        ...
        return SpatialMethodHelper.getBooleanExpression(stmt, "st_intersects", funcArgs, exprFactory);
    }
}
