 ...
 */
public class SpatialCentroidMethod3 extends AbstractSQLMethod
{
    public SQLExpression getExpression(SQLExpression expr, List args)
    {
        if (expr == null && (args == null || args.size() != 1))
        {
            throw new NucleusUserException("Cannot invoke Spatial.centroid without 1 argument");
        }
        else if (expr != null && args != null && args.size() != 0)
        {
            throw new NucleusUserException("Cannot invoke geom.getCentroid() with an argument");
        }
        ...
        return new GeometryExpression(stmt, geomMapping, "st_centroid", funcArgs, null);
    }
}
