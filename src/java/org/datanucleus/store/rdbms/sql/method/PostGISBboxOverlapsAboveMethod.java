 ...
 */
public class PostGISBboxOverlapsAboveMethod extends AbstractSQLMethod
{
    ...
    public SQLExpression getExpression(SQLExpression ignore, List args)
    {
        ...
        {
            throw new NucleusUserException("Cannot invoke PostGIS.bboxOverlapsAbove without 2 arguments");
        }
