 ...
 */
public class SpatialMLineFromWKBMethod extends AbstractSQLMethod
{
    /* (non-Javadoc)
    ...
    public SQLExpression getExpression(SQLExpression expr, List args)
    {
        ...
        {
            throw new NucleusUserException("Cannot invoke Spatial.mLineFromWKB without 2 arguments");
        }
        ...
        return new GeometryExpression(stmt, null, "MLineFromWKB", funcArgs, null);
    }
}