 ...
 */
public class SpatialPointFromWKBMethod extends AbstractSQLMethod
{
    /* (non-Javadoc)
    ...
    public SQLExpression getExpression(SQLExpression expr, List args)
    {
        ...
        {
            throw new NucleusUserException("Cannot invoke Spatial.pointFromWKB without 2 arguments");
        }
        ...
        return new GeometryExpression(stmt, null, "PointFromWKB", funcArgs, null);
    }
}