...
/**
 * Implementation of "Spatial.convexHull(expr)" or "{expr}.convexHull(expr2)" method.
 */
public class SpatialConvexHullMethod extends AbstractSQLMethod
{
    /* (non-Javadoc)
    ...
    public SQLExpression getExpression(SQLExpression expr, List args)
    {
        ...
        return new GeometryExpression(stmt, geomMapping, "ConvexHull", funcArgs, null);
    }
}