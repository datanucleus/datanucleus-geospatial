 ...
 */
public class MySqlMbrTouchesMethod extends AbstractSQLMethod
{
    /*
     * (non-Javadoc)
     * @see
    ...
    public SQLExpression getExpression(SQLExpression ignore, List args)
    {
        ...
        {
            throw new NucleusUserException("Cannot invoke MySQL.mbrTouches without 2 arguments");
        }
        ...
        return SpatialMethodHelper.getBooleanExpression(stmt, "MBRTouches", funcArgs, exprFactory);
    }
}