...
/**
 * Mapping for a ESRI Path object to PostGIS.
 */
public class PathRDBMSMapping extends GeometryRDBMSMapping
{
    public PathRDBMSMapping(JavaTypeMapping mapping, RDBMSStoreManager storeMgr, Column col)
    {
    ...
    public Object getObject(ResultSet rs, int exprIndex)
    {
        ...
        try
        {
            ...
            {
                value = new Path(getFromWkb(binaryResult));
            }
        }
