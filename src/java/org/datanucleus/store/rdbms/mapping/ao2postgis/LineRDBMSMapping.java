...
/**
 * Mapping for a ESRI Line object to PostGIS.
 */
public class LineRDBMSMapping extends GeometryRDBMSMapping
{
    public LineRDBMSMapping(JavaTypeMapping mapping, RDBMSStoreManager storeMgr, Column col)
    {
    ...
    public Object getObject(ResultSet rs, int exprIndex)
    {
        ...
        try
        {
            ...
            {
                value = new Line(getFromWkb(binaryResult));
            }
        }
