...
/**
 * Mapping for a ESRI Polygon object to PostGIS.
 */
public class PolygonRDBMSMapping extends GeometryRDBMSMapping
{
    public PolygonRDBMSMapping(JavaTypeMapping mapping, RDBMSStoreManager storeMgr, Column col)
    {
    ...
    public Object getObject(ResultSet rs, int exprIndex)
    {
        ...
        try
        {
            ...
            {
                value = new Polygon(getFromWkb(binaryResult));
            }
        }
