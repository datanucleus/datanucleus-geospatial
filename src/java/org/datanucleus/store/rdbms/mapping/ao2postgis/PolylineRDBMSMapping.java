...
/**
 * Mapping for a ESRI Polyline object to PostGIS.
 */
public class PolylineRDBMSMapping extends GeometryRDBMSMapping
{
    public PolylineRDBMSMapping(JavaTypeMapping mapping, RDBMSStoreManager storeMgr, Column col)
    {
    ...
    public Object getObject(ResultSet rs, int exprIndex)
    {
        ...
        try
        {
            ...
            {
                value = new Polyline(getFromWkb(binaryResult));
            }
        }
