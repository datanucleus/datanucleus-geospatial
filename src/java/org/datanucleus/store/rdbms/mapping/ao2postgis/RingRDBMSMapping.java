...
/**
 * Mapping for a ESRI Ring object to PostGIS.
 */
public class RingRDBMSMapping extends GeometryRDBMSMapping
{
    public RingRDBMSMapping(JavaTypeMapping mapping, RDBMSStoreManager storeMgr, Column col)
    {
    ...
    public Object getObject(ResultSet rs, int exprIndex)
    {
        ...
        try
        {
            ...
            {
                value = new Ring(getFromWkb(binaryResult));
            }
        }
