 ...
 */
public class SpatialLineFromTextMethod extends AbstractSQLMethod
{
    /*
     * (non-Javadoc)
     * @see
    ...
    public SQLExpression getExpression(SQLExpression expr, List args)
    {
        ...
        {
            throw new NucleusUserException("Cannot invoke Spatial.lineFromText without 2 arguments");
        }
        ...
        return new GeometryExpression(stmt, null, "LineFromText", funcArgs, null);
    }
}