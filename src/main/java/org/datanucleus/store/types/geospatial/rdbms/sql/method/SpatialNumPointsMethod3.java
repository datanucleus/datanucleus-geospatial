 ...
 */
public class SpatialNumPointsMethod3 extends AbstractSQLMethod
{
    public SQLExpression getExpression(SQLExpression expr, List args)
    {
        if (expr == null && (args == null || args.size() != 1))
        {
            throw new NucleusUserException("Cannot invoke Spatial.numPoints without 1 argument");
        }
        ...
        return new NumericExpression(stmt, m, "st_numpoints", funcArgs);
    }
}
