 ...
 */
public class PGbox3dRDBMSMapping extends AbstractDatastoreMapping
{
    ...
    public PGbox3dRDBMSMapping(JavaTypeMapping mapping, RDBMSStoreManager storeMgr, Column col)
    {
