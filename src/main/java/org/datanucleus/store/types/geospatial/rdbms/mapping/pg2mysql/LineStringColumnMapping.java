...
/**
 * Mapping for a PostGIS-JDBC LineString object to MySQL.
 */
public class LineStringColumnMapping extends GeometryColumnMapping
{
    private static final SQLTypeInfo typeInfo;
    static
    {
        typeInfo = (SQLTypeInfo) MySQLSpatialTypeInfo.TYPEINFO_PROTOTYPE.clone();
        typeInfo.setTypeName("LINESTRING");
        typeInfo.setLocalTypeName("LINESTRING");
    }

    public LineStringColumnMapping(JavaTypeMapping mapping, RDBMSStoreManager storeMgr, Column col)
    {
