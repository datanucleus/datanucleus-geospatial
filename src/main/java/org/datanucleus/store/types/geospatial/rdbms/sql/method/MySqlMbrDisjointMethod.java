 ...
 */
public class MySqlMbrDisjointMethod extends AbstractSQLMethod
{
    /*
     * (non-Javadoc)
     * @see
    ...
    public SQLExpression getExpression(SQLExpression ignore, List args)
    {
        ...
        {
            throw new NucleusUserException("Cannot invoke MySQL.mbrDisjoint without 2 arguments");
        }
        ...
        return SpatialMethodHelper.getBooleanExpression(stmt, "MBRDisjoint", funcArgs, exprFactory);
    }
}