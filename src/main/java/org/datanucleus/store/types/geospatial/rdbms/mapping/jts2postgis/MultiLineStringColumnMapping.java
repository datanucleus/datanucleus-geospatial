 ...
 */
public class MultiLineStringColumnMapping extends GeometryColumnMapping
{
    ...
    public MultiLineStringColumnMapping(JavaTypeMapping mapping, RDBMSStoreManager storeMgr, Column col)
    {
