 ...
 */
public class LineStringRDBMSMapping extends GeometryRDBMSMapping
{
    ...
    public LineStringRDBMSMapping(JavaTypeMapping mapping, RDBMSStoreManager storeMgr, Column col)
    {
