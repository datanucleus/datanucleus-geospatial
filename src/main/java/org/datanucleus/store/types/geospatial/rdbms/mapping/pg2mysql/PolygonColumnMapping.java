 ...
 */
public class PolygonColumnMapping extends GeometryColumnMapping
{
    ...
    public PolygonColumnMapping(JavaTypeMapping mapping, RDBMSStoreManager storeMgr, Column col)
    {
