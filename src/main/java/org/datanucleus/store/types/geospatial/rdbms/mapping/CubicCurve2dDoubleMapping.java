...
public class CubicCurve2dDoubleMapping extends SingleFieldMultiMapping
{
    ...
    public void setObject(ExecutionContext ec, PreparedStatement ps, int[] exprIndex, Object value)
    {
        ...
        {
            getColumnMapping(0).setDouble(ps, exprIndex[0], cubicCurve.getX1());
            getColumnMapping(1).setDouble(ps, exprIndex[1], cubicCurve.getY1());
            getColumnMapping(2).setDouble(ps, exprIndex[2], cubicCurve.getCtrlX1());
            getColumnMapping(3).setDouble(ps, exprIndex[3], cubicCurve.getCtrlY1());
            getColumnMapping(4).setDouble(ps, exprIndex[4], cubicCurve.getCtrlX2());
            getColumnMapping(5).setDouble(ps, exprIndex[5], cubicCurve.getCtrlY2());
            getColumnMapping(6).setDouble(ps, exprIndex[6], cubicCurve.getX2());
            getColumnMapping(7).setDouble(ps, exprIndex[7], cubicCurve.getY2());
        }
    }
    ...
    public Object getObject(ExecutionContext ec, ResultSet resultSet, int[] exprIndex)
    {
        ...
        double ctrlx1 = getColumnMapping(2).getDouble(resultSet, exprIndex[2]);
        double ctrly1 = getColumnMapping(3).getDouble(resultSet, exprIndex[3]);
        double ctrlx2 = getColumnMapping(4).getDouble(resultSet, exprIndex[4]);
        double ctrly2 = getColumnMapping(5).getDouble(resultSet, exprIndex[5]);
        double x2 = getColumnMapping(6).getDouble(resultSet, exprIndex[6]);
        double y2 = getColumnMapping(7).getDouble(resultSet, exprIndex[7]);
