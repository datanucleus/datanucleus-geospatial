 ...
 */
public class SpatialGeographyFromWKBMethod extends AbstractSQLMethod
{
    public SQLExpression getExpression(SQLExpression expr, List args)
    {
        if (args == null || 1 != args.size())
        {
            throw new NucleusUserException("Cannot invoke Spatial.geogFromWKB without 1 arguments.");
        }
        ...
        return new GeometryExpression(stmt, null, "st_geogfromwkb", funcArgs, null);
    }
}
