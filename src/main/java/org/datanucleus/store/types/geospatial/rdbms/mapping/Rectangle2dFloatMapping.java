...
public class Rectangle2dFloatMapping extends SingleFieldMultiMapping
{
    ...
    public void setObject(ExecutionContext ec, PreparedStatement ps, int[] exprIndex, Object value)
    {
        ...
        {
            getColumnMapping(0).setFloat(ps, exprIndex[0], rectangle.x);
            getColumnMapping(1).setFloat(ps, exprIndex[1], rectangle.y);
            getColumnMapping(2).setFloat(ps, exprIndex[2], rectangle.width);
            getColumnMapping(3).setFloat(ps, exprIndex[3], rectangle.height);
        }
    }
