 ...
 */
public class SpatialMPolyFromTextMethod extends AbstractSQLMethod
{
    /*
     * (non-Javadoc)
     * @see
    ...
    public SQLExpression getExpression(SQLExpression expr, List args)
    {
        ...
        {
            throw new NucleusUserException("Cannot invoke Spatial.mPolyFromText without 2 arguments");
        }
        ...
        return new GeometryExpression(stmt, null, "MPolyFromText", funcArgs, null);
    }
}