 ...
 */
public class MySqlMbrOverlapsMethod extends AbstractSQLMethod
{
    /*
     * (non-Javadoc)
     * @see
    ...
    public SQLExpression getExpression(SQLExpression ignore, List args)
    {
        ...
        {
            throw new NucleusUserException("Cannot invoke MySQL.mbrOverlaps without 2 arguments");
        }
        ...
        return SpatialMethodHelper.getBooleanExpression(stmt, "MBROverlaps", funcArgs, exprFactory);
    }
}